...
The Current Working Directory should, if possbile, be set to ./MachineLearningClassifiers/ should the program be ran through an IDE.
...
The K-Nearest Neighbor and Decision Tree classifier uses the "dataset" directory to perform a k-fold cross-validation, splitting the data into training and testing sets.
...
An Excel spreadsheet containing the best parameters and their mean time when using GridSearchCV. (Decision Tree and KNN)
...
The CNN is located in the VGG-16 Classifier subfolder and is contained in the VGG-16Classifier.py file.
...
The dataset consists of two subfolders: occupied and unoccupied. Each subfolder contains samples of the corresponding class and have been pre-augmented.
